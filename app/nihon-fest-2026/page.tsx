          ...
          <div className="slide-inner">
            ...
            <div className="pillars">
              <div className="pillar">
                ...
                <div className="pillar-name">First Principle Thinking</div>
                <div className="pillar-who">Aristoteles → Elon Musk</div>
              </div>
              <div className="pillar">
                <div className="pillar-num">II</div>
                <div className="pillar-name">System Thinking</div>
                <div className="pillar-who">Forrester · Senge → Steve Jobs</div>
              </div>
              <div className="pillar">
                <div className="pillar-num">III</div>
                <div className="pillar-name">Critical Thinking</div>
                <div className="pillar-who">Sokrates · Dewey → Engineer Modern</div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="slide slide-pillar" data-slide={11}>
          <div className="slide-inner">
            <div className="pillar-header">
              ...
              <h2 className="pillar-h">First Principle Thinking</h2>
              <p className="pillar-tag">Membongkar masalah sampai ke kebenaran paling dasar.</p>
            </div>

            <div className="pillar-body">
              <div className="pillar-lineage">
                <div className="lineage-step">
                  <div className="lineage-year">350 SM</div>
                  <div className="lineage-name">Aristoteles</div>
                  <div className="lineage-note">
                    Dalam <em>Metaphysics</em> &amp; <em>Physics</em> — &ldquo;Pahami sesuatu
                ...
                <div className="lineage-step">
                  ...
                  <div className="lineage-note">
                    SpaceX: roket 10× lebih murah dengan menghitung ulang harga bahan baku.
                    Tesla: $600 → $80 per kWh dengan membongkar baterai ke tingkat logam.
                  </div>
                </div>
              </div>
              ...
              <blockquote className="pillar-quote">
                <p>
                  &ldquo;I think it&rsquo;s important to reason from first principles rather than
                  by analogy. You boil things down to the most fundamental truths and reason up
                  from there.&rdquo;
                </p>
                <cite>— Elon Musk</cite>
                <span className="quote-id">
                  &ldquo;Saya pikir penting untuk bernalar dari prinsip pertama, bukan dari analogi.
                  Kupas sesuatu sampai kebenaran paling dasar, lalu bangun dari sana.&rdquo;
                </span>
              </blockquote>
        ...
        <section className="slide slide-pillar" data-slide={12}>
          <div className="slide-inner">
            <div className="pillar-header">
              ...
              <h2 className="pillar-h">System Thinking</h2>
              <p className="pillar-tag">Melihat keterhubungan, bukan hanya bagian-bagian.</p>
            </div>

            <div className="pillar-body">
              <div className="pillar-lineage">
                <div className="lineage-step">
                  <div className="lineage-year">1950–60</div>
                  <div className="lineage-name">Jay Forrester (MIT)</div>
                  <div className="lineage-note">
                    Meletakkan fondasi <em>system dynamics</em> — bahwa perilaku sistem muncul
                ...
                <div className="lineage-step">
                  ...
                  <div className="lineage-note">
                    <em>The Fifth Discipline</em> — organisasi yang berhasil adalah yang bisa
                ...
                <div className="lineage-step">
                  ...
                  <div className="lineage-note">
                    Kelas kaligrafi &rarr; 10 tahun kemudian &rarr; tipografi Mac.
                    Titik-titik hanya bisa dihubungkan dengan melihat <em>ke belakang</em>.
                  </div>
                </div>
              </div>
              ...
              <blockquote className="pillar-quote">
                <p>
                  &ldquo;You can&rsquo;t connect the dots looking forward; you can only connect
                  them looking backwards. So you have to trust that the dots will somehow
                  connect in your future.&rdquo;
                </p>
                <cite>— Steve Jobs, Stanford Commencement 2005</cite>
                <span className="quote-id">
                  &ldquo;Kamu tidak bisa menghubungkan titik-titik dengan melihat ke depan;
                  hanya bisa dengan melihat ke belakang. Jadi kamu harus percaya bahwa titik-titik itu
                  akan terhubung di masa depan.&rdquo;
                </span>
              </blockquote>
        ...
        <section className="slide slide-pillar" data-slide={13}>
          <div className="slide-inner">
            ...
            <div className="pillar-body">
              <div className="pillar-lineage">
                <div className="lineage-step">
                  <div className="lineage-year">400 SM</div>
                  <div className="lineage-name">Sokrates</div>
                  <div className="lineage-note">
                    <em>&ldquo;The unexamined life is not worth living.&rdquo;</em>
                    <span className="lineage-id">
                      &ldquo;Hidup yang tidak diperiksa tidak layak dijalani.&rdquo;
                    </span>
