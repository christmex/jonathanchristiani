    ...
    <>
      <section className="grid grid-cols-1 lg:grid-cols-2 min-h-[calc(100dvh-10rem)]">
        ...
        <div className="p-10 border border-slate-100 border-l-0 relative">
          ...
          <p className="text-xl mt-4">I'm Jonathan from Indonesia <br />—<span className="font-bold">Senior Laravel & Next.js Developer</span>, <br className="lg:hidden" />partime as a <span className="font-bold">truth seeker</span>.</p>
        </div>
        ...
        <div className="flex border-y lg:flex-row flex-col">
          ...
          <div className="lg:basis-6/8 w-full order-1 lg:order-2">
            ...
            <div className="bg-slate-100 h-[500px] relative">
              ...
              <Image src="/images/projects/nihonnomise.id.png" alt="Nihonnomise.id" fill className="object-cover" />
        ...
        <div className="flex border-y lg:flex-row flex-col">
          ...
          <div className="lg:basis-6/8 w-full order-1">
            ...
            <div className="bg-slate-100 h-[500px] relative">
              ...
              <Image src="/images/projects/elegantgorden.com.png" alt="Elegant Gorden" fill className="object-cover" />
